...
model = pickle.load(open('build.pkl','rb'))   ### import model - Random Forest
...
def predict():
    ...
    output = round(prediction[0]**2,4)  # to Get original Premium Amount
    return render_template('index.html',
                           prediction_text="Premium Amount {}".format(math.floor(output)))
